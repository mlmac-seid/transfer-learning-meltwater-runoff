...
Run MLP on all years of AK4 catchment-scale data to predict a random year.
"""
...
from catchment_training_experiments_log import log_catchment_training_experiment, catchment_training_log_ak4
...
ak4_catchment_2000_2024_df = pd.read_csv(
    "./AK4_catchment_variables/ak4_catchment_2000_2024_vars.csv")
ak4_catchment_2000_2024_df['time'] = pd.to_datetime(
    ak4_catchment_2000_2024_df['time'], errors='coerce')
...
for i in range(100):
    ...
    withheld_mask = ak4_catchment_2000_2024_df['time'].dt.year == random_year
    test_random = ak4_catchment_2000_2024_df[withheld_mask].reset_index(
        drop=True)
    ...
    for N in range(1, len(remaining_years) + 1):
        ...
        train_mask = ak4_catchment_2000_2024_df['time'].dt.year.isin(
            train_years)
        train_df = ak4_catchment_2000_2024_df[train_mask].reset_index(drop=True)
    ...
    for N, df in training_sets.items():
        ...
        log_catchment_training_experiment(log_file=catchment_training_log_ak4,
