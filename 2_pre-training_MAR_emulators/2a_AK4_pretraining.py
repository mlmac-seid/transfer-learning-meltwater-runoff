...
# -*- coding: utf-8 -*-
"""
Created on Thu Mar 26 11:24:07 2026

@author: mlm211

Pre-train MLP with AK4 catchment-scale MAR predictors for 2000-2024.
"""
...
# Load 2000-2024 MAR data for AK4
...
# Fit scalers
x_scaler = StandardScaler().fit(ak4_mar[t2m_ts_al2_swd])
y_scaler = StandardScaler().fit(ak4_mar[["meltwater_runoff"]])

# # Scale training data
x_train = x_scaler.transform(ak4_mar[t2m_ts_al2_swd])
y_train_scaled = y_scaler.transform(
    ak4_mar[["meltwater_runoff"]]).flatten()
...
save_path_tl = './catchment_MAR_emulators/ak4_mar_mlp.keras'
...
# Save scalers
joblib.dump(
    x_scaler, './catchment_MAR_emulators/ak4_mar_xscaler.pkl')
joblib.dump(
    y_scaler, './catchment_MAR_emulators/ak4_mar_yscaler.pkl')
