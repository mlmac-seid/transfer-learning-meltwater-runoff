...
# -*- coding: utf-8 -*-
"""
Created on Thu Mar 26 15:45:06 2026

@author: mlm211

Pre-train MLP with North catchment-scale MAR t2m and al2 for 2000-2024.
"""
...
# Load 2000-2024 MAR data for North
...
# Fit scalers
x_scaler = StandardScaler().fit(north_mar[t2m_ts_al2_swd])
y_scaler = StandardScaler().fit(north_mar[["meltwater_runoff"]])

# # Scale training data
x_train = x_scaler.transform(north_mar[t2m_ts_al2_swd])
y_train_scaled = y_scaler.transform(
    north_mar[["meltwater_runoff"]]).flatten()
...
save_path_tl = './catchment_MAR_emulators/north_mar_mlp.keras'
...
# Save scalers
joblib.dump(
    x_scaler, './catchment_MAR_emulators/north_mar_xscaler.pkl')
joblib.dump(
    y_scaler, './catchment_MAR_emulators/north_mar_yscaler.pkl')
